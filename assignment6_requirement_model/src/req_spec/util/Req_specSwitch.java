 ...
 * @generated
 */
public class Req_specSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Req_specPackage.REQUIREMENTS_SPECIFICATION: {
			...
			case Req_specPackage.REQUIREMENT: {
				Requirement requirement = (Requirement)theEObject;
				T result = caseRequirement(requirement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.CATEGORY: {
				Category category = (Category)theEObject;
				T result = caseCategory(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.FUNCTIONAL_REQUIREMENT: {
			...
			case Req_specPackage.QUALITY_REQUIREMENT: {
			...
			case Req_specPackage.DESCRIPTION: {
				Description description = (Description)theEObject;
				T result = caseDescription(description);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.UNARY_DEPENDENCY: {
				UnaryDependency unaryDependency = (UnaryDependency)theEObject;
				T result = caseUnaryDependency(unaryDependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.ICOST: {
				ICost iCost = (ICost)theEObject;
				T result = caseICost(iCost);
				if (result == null) result = caseUnaryDependency(iCost);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.CVALUE: {
				CValue cValue = (CValue)theEObject;
				T result = caseCValue(cValue);
				if (result == null) result = caseUnaryDependency(cValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.REFINES: {
				Refines refines = (Refines)theEObject;
				T result = caseRefines(refines);
				if (result == null) result = caseUnaryDependency(refines);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.REQUIRES: {
				Requires requires = (Requires)theEObject;
				T result = caseRequires(requires);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Req_specPackage.BINARY_EXPRESSION: {
			...
			case Req_specPackage.UNARY_EXPRESSION: {
